...
if(isset($_POST['mail_array']) && isset($_POST['with_prices']) && isset($_POST['with_pics'])){
    ...
    $result.=($with_pics == 1)? "<td><img src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAS4AAACCCAYAAAD46SViAAAACXBIWXMAAAsTAAALEwEAmpwYAAAg
...
TkSuQmCC\" alt=\"img\" /></td>" : "<td style='width: 30%'><b style='font-size: 20px'>ООО \"Лубритэк\" </b></td>";
