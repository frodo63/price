...
INSERT INTO `soges` VALUES (1,'Avantin 361 I-N','Bechem','Резание, Шлифование','Хорошая совместимость с кожей и отличные качества для обработки резанием, прежде всего при процессах обработки, при которых требуется повышенная смазывающая способность для инструмента. Подходит для любого качества воды, не пенится','Алюминий, Цветные металлы, Сталь','Резание алюминия: 7 - 10%, Резание стали: 5 - 7%','20л - 11000р<br>200л - 102000р'),(2,'Avantin 320 S','Bechem','Резание, Шлифование','Очень хорошая защита от коррозии и превосходные моющие свойства. Данный продукт беcпроблемно применяется в воде, имеющей жесткость от 3°dH. Он обладает высокой стабильностью эмульсии и, исходя из этого, длительными сроками службы эмульсии.','Сталь низколегированная, Чугун','Общее резание: 3-6%, Сложное резание: 5-10%','20л - 8100р\n<br>\n200л - 78300р'),(3,'Avantin 402','Bechem','Резание, Шлифование','Не содержащий минерального масла водосмешиваемый концентрат СОЖ с хорошими антикоррозионными свойствами. Благодаря специальному аддитивированию BECHEM Avantin 402 успешно применяется при обработке резанием стальных и чугунных материалов и при нарезке резьбы. Cтороннее масло не эмульгируется, поэтому не возникает задымления.','Сталь, Чугун','Общее резание: 6-10%, Шлифование: 4-5%','20л - 10000р<br>200л - 99100р');
...
-- Dump completed on 2019-12-06  1:35:50
